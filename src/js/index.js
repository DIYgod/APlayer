...
class APlayer {
    ...
    constructor (option) {
        const svg = {
            ...
            'previous' : ['0 0 72 42','M35.965,0.114c-0.329-0.171-0.726-0.148-1.033,0.063L7.5,19.095V1c0-0.553-0.448-1-1-1s-1,0.447-1,1v40c0,0.553,0.448,1,1,1  s1-0.447,1-1V22.905l27.432,18.919C35.103,41.94,35.301,42,35.5,42c0.159,0,0.319-0.038,0.465-0.114  C36.294,41.713,36.5,41.372,36.5,41V1C36.5,0.628,36.294,0.287,35.965,0.114z'],
            'next' :     ['0 0 72 42','M35.5,0c-0.552,0-1,0.447-1,1v18.095L7.068,0.177C6.762-0.034,6.364-0.057,6.035,0.114C5.706,0.287,5.5,0.628,5.5,1v40  c0,0.372,0.206,0.713,0.535,0.886C6.181,41.962,6.341,42,6.5,42c0.199,0,0.397-0.06,0.568-0.177L34.5,22.905V41c0,0.553,0.448,1,1,1  s1-0.447,1-1V1C36.5,0.447,36.052,0,35.5,0z']
        };
        this.getSVG = (type) => `
            ...
            <div class="aplayer-info">
                ...
                <div class="aplayer-controller">
                    ...
                    <div class="aplayer-time">
                        ...
                        <button type="button" class="aplayer-icon aplayer-icon-menu aplayer-previous">
                            ${this.getSVG('previous')}
                        </button>
                        <button type="button" class="aplayer-icon aplayer-icon-menu aplayer-next">
                            ${this.getSVG('next')}
                        </button>
                    </div>
                </div>
        ...
        // Play next song
        this.button = this.element.getElementsByClassName('aplayer-next')[0];
        this.button.addEventListener('click', () => {        
            if(this.option.music[this.playIndex + 1] != null) {
        ...
        // Play previous song 
        this.button = this.element.getElementsByClassName('aplayer-previous')[0];
        this.button.addEventListener('click', () => {        
            if(this.option.music[this.playIndex - 1] != null) {
                this.setMusic(this.playIndex - 1);
                this.play();
